...
void bind_zp(py::module_ &m) {
    py::class_<Zp>(m, "Zp", R"pbdoc(
        ...
        .def_static("from_rational", &Zp::from_rational,
                    py::arg("numerator"), py::arg("denominator"),
                    py::arg("prime"), py::arg("precision"),
                    R"pbdoc(
            Create Zp from rational number.
            
            Args:
                numerator: Numerator
                denominator: Denominator (must be coprime to p)
                prime: The prime p
                precision: Desired precision
                
            Returns:
                Zp representing numerator/denominator
                
            Raises:
                std::domain_error: If denominator is divisible by p
        )pbdoc")
